$(document).on('ready', function(){
	...
	$('.section-portfolio .btn-view-more').on('click', function(){
		$('.section-portfolio .grid-item.hidden').slice(0,3).removeClass("hidden");

		if($('.section-portfolio .grid-item.hidden').length == 0)
